        ...
        <div className="container mx-auto px-4 py-20 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-red-100 mb-8 max-w-2xl mx-auto">
              Our advanced Blood Donor Network ensures efficient
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/auth">
                <button className="inline-flex items-center justify-center px-6 py-3 text-lg font-medium rounded-3xl bg-white text-red-700 hover:bg-red-50 transition-all duration-300 shadow-lg hover:shadow-xl">
                  Get Started <ArrowRight className="w-4 h-4 ml-2" />
                </button>
              </Link>
              <Link to="#about">
                <button className="inline-flex items-center justify-center px-6 py-3 text-lg font-medium rounded-3xl border-2 border-white text-white hover:bg-white/10 transition-all duration-300">
                  Learn More
                </button>
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => {
              ...
              const colors = ['border-b-red-600', 'border-b-blue-600', 'border-b-emerald-600', 'border-b-purple-600'];
              return (
                <div
                  key={index}
                  className={`text-center p-6 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-b-4 ${colors[index]}`}
                >
                  <div className="bg-red-50 p-3 rounded-xl text-red-600 w-12 h-12 flex items-center justify-center mx-auto mb-4">
                  ...
                  <div className="bg-slate-100 text-slate-600 px-3 py-1 rounded-full text-xs font-bold inline-block mt-2">
                    +{12 + index * 3}%
                  </div>
                </div>
              );
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {bloodTypes.map((blood, index) => (
              <div
                key={index}
                className="bg-white rounded-3xl shadow-sm border border-slate-200 p-4 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
                <div
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {donationFacts.map((fact, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-slate-50 rounded-3xl shadow-sm border border-slate-200 p-6 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-t-4 border-t-red-600"
                >
                  <div className="bg-red-50 p-3 rounded-xl text-red-600 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
            ...
            {processSteps.map((step, index) => {
              ...
              return (
                <div key={index} className="text-center group">
                  <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-t-4 border-t-red-600 h-80 flex flex-col justify-between">
                    <div>
                      <div className="bg-slate-100 text-slate-600 px-3 py-1 rounded-full text-xs font-bold w-12 h-12 flex items-center justify-center mx-auto mb-4">
                        {step.step}
                      </div>
                      {Icon && (
                        <div className="bg-red-50 p-3 rounded-xl text-red-600 w-12 h-12 mx-auto mb-4 flex items-center justify-center">
                          <Icon className="w-6 h-6" />
                        </div>
                      )}
                    </div>
                    <div>
                      ...
                      <p className="text-slate-500 font-medium text-sm">{step.description}</p>
                    </div>
                  </div>
                </div>
              );
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {eligibilityInfo.map((info, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-slate-50 rounded-3xl shadow-sm border border-slate-200 p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-t-4 border-t-red-600"
                >
