...
import { Droplet, Plus, Minus, AlertTriangle, CheckCircle, Calendar, RefreshCw, ArrowLeft, Shield } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm border border-slate-200 rounded-3xl">
              ...
              <span className="font-bold text-slate-900">Blood Stock</span>
            </div>
          </div>
        </div>
      </div>
