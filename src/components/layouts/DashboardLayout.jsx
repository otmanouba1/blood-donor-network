        ...
        try {
          ...
          if (res.ok) {
            ...
            if (user.role.toLowerCase() !== userRole.toLowerCase()) {
              // Handle role normalization for blood-lab vs blood_lab
              const normalizedUserRole = userRole.toLowerCase().replace("-", "_");
              const normalizedBackendRole = user.role.toLowerCase().replace("-", "_");
              
              if (normalizedBackendRole !== normalizedUserRole) {
